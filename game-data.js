...
const GAME_DATA = {
  ...
  events: {
    ...
    E14: {
      ...
      choices: [
        { id:"A", label:"「そっか。寂しくなるね……」", points:4, rival:0, expr:"soft", reaction:"「うちな、兄ちゃんおらんくなったら、一人になる気がして怖いねん。……子供の頃からずっと、誰かがおらんとあかん性格でな」\n\nそこまで言って、ハナエは口をつぐんだ。言い過ぎた、という顔だった。" },
        ...
        // 「一人になるのが怖い」までは届かない = +2。本文の「電車で行ける距離やのにな」を受ける
        { id:"D", label:"「電車で行けるなら、会いに行けばいいよ」", points:2, rival:0, expr:"soft", reaction:"「……せやな。会いに行ったらええだけの話やな」\n\nそう言って笑ったけど、ケータイを握る手は、まだ少し固かった。" },
      ],
    },
