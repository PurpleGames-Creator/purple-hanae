...
兄のトウマが差し入れの紙袋に『誕生日』と書いて寄越したせいで、委員会中に知れ渡った。\n\n作業終わり、誰かが買ってきたコンビニのケーキに、蝋燭が一本だけ立つ。\n\n「なんやこれ、恥ずかしいねんけど」\n\nそう言いながら、ハナエは蝋燭を消すまで誰にも席を譲らなかった。`,
    ...
    E19: {
      ...
      rumorLine: "\n\nそう言った直後、机の上のケータイが一度光った。画面を見て、ハナエの口元が少しだけ緩む。吉沢、という文字が見えた気がした。",
      choices: [
  ...
  freePool: {
    ...
    F5_nishino: {
      ...
      choices: [
        ...
        { id:"B", label:"何も言わず吉沢に任せる", points:-1, rival:4, tag:"passive", expr:"lonely", reaction:"「あ……うん、ありがと」" },
  ...
  // 吉沢エンドだけは気づきようがない(2026-09-09 本人指示)
  endingHints: {
    nishino: "※ライバルの影…",
  },
