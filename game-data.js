...
const GAME_DATA = {
  ...
  events: {
    ...
    E6: {
      ...
      text: `ハナエはテニスの大会本番。委員会の作業量は多く、他のメンバーが俺に相談してきた。`,
      choices: [
...
「うちら家族、そろって和菓子好きでな。ちっちゃい頃から親に連れられて、休みのたびに和菓子屋ばっかり回っとってん」`,
      choices: [
        ...
        { id:"D", label:"作業に戻る", points:-2, rival:0, tag:"passive", expr:"lonely", reaction:"ハナエは少し寂しそうな顔" },
      ],
    },
    ...
    E9: {
      ...
      choices: [
        ...
        { id:"D", label:"買っておいたスポーツドリンクをベンチに置き、委員会へ向かう", points:3, rival:0, expr:"soft", reaction:"その日の昼「……あれ、あんたやろ。ありがと。」" },
      ],
    },
    ...
    E13: {
      ...
      choices: [
        ...
        { id:"C", label:"「早く止まないかな～」", points:-2, rival:0, tag:"passive", expr:"lonely", reaction:"少し寂しそうな顔をされる。" },
    ...
    E16: {
      ...
      choices: [
        ...
        { id:"B", label:"ハナエに任せて自分は他の作業を続ける", points:-2, rival:0, tag:"passive", expr:"lonely", reaction:"少し寂しげな視線。" },
        { id:"C", label:"一緒に黙々と修復作業を手伝う", points:2, rival:0, expr:"soft", reaction:"隣で一緒に手を動かしてくれることに安心した様子。" },
  ...
  freePool: {
    ...
    F2_chusai: {
      ...
      choices: [
        ...
        { id:"C", label:"増えた分の作業を黙って一緒にこなす", points:2, rival:0, expr:"soft", reaction:"言葉はないが、行動で示す優しさとして伝わる。" },
    ...
    F5_nishino: {
      ...
      choices: [
        ...
        { id:"D", label:"「みんなでやれば早いから俺もやるよ」", points:1, rival:1, expr:"normal", reaction:"特に牽制にはならなかった。" },
      ],
    },
