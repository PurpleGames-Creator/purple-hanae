...
兄のトウマが差し入れの紙袋に『誕生日』と書いて寄越したせいで、委員会中に知れ渡った。\n\n作業終わり、誰かが買ってきたコンビニのケーキに、蝋燭が一本だけ立つ。\n\n「なんやこれ、恥ずかしいねんけど」\n\nそう言いながら、ハナエは蝋燭を消すまで誰にも席を譲らなかった。`,
    ...
    // 二か月一緒にいて名前を呼んだことがない、という事実を彼女自身に
    // 言わせることで、「意識しているから呼べない」を説明せずに見せる。
    //
    // 名札作りにしてあるのは、彼女が名前を聞かざるを得ない理由を作るため。
    // 直後が E17(吉沢がハナエをカラオケに誘う)なので、対比も効く
    E16B: {
      title: "名札",
      text: `文化祭当日に付ける名札を、実行委員のぶんだけ先に作ることになった。\n\n委員「ハナエ、その人の名札たのむわ」\n\nハナエはペンを持ったまま、少し止まった。\n\nハナエ「……名前、どう書くん」\n\n委員「え、知らんの? いっつも一緒におるのに」\n\nハナエ「呼んだことないもん。『あんた』で足りてるし」\n\n言いながら、ハナエは一度もこちらを見なかった。`,
      choices: [
        { id:"A", label:"「呼びたくなったら、呼んでよ」", points:3, rival:0, expr:"shy", reaction:"ハナエ「……いつになるか、わからんで」\n\nそう言いながら、名札に俺の名前を書いていた。" },
        { id:"B", label:"自分で書くと言って、ペンに手を伸ばす", points:1, rival:0, expr:"normal", reaction:"ハナエ「……ええわ、うちが書く」\n\n結局、ペンは返ってこなかった。" },
        { id:"C", label:"「『あんた』でいいよ」", points:-1, rival:0, expr:"lonely", reaction:"ハナエ「……せやな。今まで通りでええか」\n\n名札は、こちらを向かないまま渡された。" },
        { id:"D", label:"「一回、名前で呼んでみてよ」", points:-2, rival:0, tag:"pushy", expr:"trouble", reaction:"ハナエ「いや、なんで急に」\n\n名札は、無言で押しつけられた。" },
      ],
    },
