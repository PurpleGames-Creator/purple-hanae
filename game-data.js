...
兄のトウマが差し入れの紙袋に『誕生日』と書いて寄越したせいで、委員会中に知れ渡った。\n\n作業終わり、誰かが買ってきたコンビニのケーキに、蝋燭が一本だけ立つ。\n\n「なんやこれ、恥ずかしいねんけど」\n\nそう言いながら、ハナエは蝋燭を消すまで誰にも席を譲らなかった。`,
    ...
    // ---- ここから文化祭本番(2026-09-07 追加)。E19 の「明日で、すべてが終わる」の続き。
    // 先手(senshu)を打った人は 9/4 の夜に告白するので、この2場面は通らない
    E20: {
      title: "文化祭一日目",
      text: `開場を知らせる放送が鳴った。\n\n二か月かけて作ったものに、初めて他人が入ってくる。\n\n入口の看板は、割れた跡が薄く残ったまま立っていた。\n\nハナエが下絵を描いて、みんなで拾い集めて貼り直した、あの看板だ。\n\nハナエ「三番の展示、まだ誰も回ってへん!先に案内して!」\n\n進行表を片手に、ハナエが人の間を縫っていく。こちらには気づいていない。\n\nその進行表の余白に、赤い字で『抜けたとこは気づいた人が入る』と走り書きがあった。`,
      choices: [
        { id:"A", label:"進行表の空いている持ち場に、黙って入る", points:4, rival:0, expr:"soft", reaction:"ハナエ「……あんた、いつからおったん」\n\nハナエ「言うてへんのに、なんで分かるん」" },
        { id:"B", label:"「看板、直した跡わからんな」", points:2, rival:0, expr:"smile", reaction:"ハナエ「せやろ。うち、あれ三時間かかっててん」" },
        { id:"C", label:"「俺たち、けっこうやったよね」", points:-1, rival:0, tag:"pushy", expr:"normal", reaction:"ハナエ「まだ終わってへんて。言うの早いわ」" },
        { id:"D", label:"忙しそうなので、声をかけずに見ている", points:-3, rival:0, tag:"passive", expr:"lonely", reaction:"声をかける機会は、その日ついに来なかった。" },
      ],
    },
