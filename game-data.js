...
兄のトウマが差し入れの紙袋に『誕生日』と書いて寄越したせいで、委員会中に知れ渡った。\n\n作業終わり、誰かが買ってきたコンビニのケーキに、蝋燭が一本だけ立つ。\n\n「なんやこれ、恥ずかしいねんけど」\n\nそう言いながら、ハナエは蝋燭を消すまで誰にも席を譲らなかった。`,
    ...
    E21: {
      title: "最終日、後夜祭の前",
      text: `最終日の片付けが始まった。\n\n提灯を外していく。台風の前に、二人で一つずつ縛り直したやつだ。\n\n外した端から、校庭が元の暗さに戻っていく。\n\n委員「明日から、ただのグラウンドやな」\n\nハナエは脚立の上で手を止めて、何も無くなった方を見ていた。\n\nハナエ「……なんも残らへんねんな、これ」\n\n体育館の方から、後夜祭の準備をする音が聞こえてくる。`,
      choices: [
        { id:"A", label:"「じゃあ、覚えとくよ。全部」", points:3, rival:0, expr:"shy", reaction:"ハナエ「……アホちゃう」\n\n外した提灯を一つ、こちらに押しつけて、脚立を降りた。" },
        { id:"B", label:"「写真、撮っとく?」", points:1, rival:0, expr:"smile", reaction:"ハナエ「あ、ええな。……って、誰が撮んの」" },
        { id:"C", label:"「打ち上げ、どうする?」と話題を変える", points:-2, rival:0, tag:"pushy", expr:"trouble", reaction:"ハナエ「いま、その話する?」" },
        { id:"D", label:"気づかないふりをして、片付けを続ける", points:-4, rival:0, tag:"passive", expr:"lonely", reaction:"提灯は、思ったより早く片付いた。" },
      ],
    },
  },
