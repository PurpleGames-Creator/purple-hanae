...
const GAME_DATA = {
  ...
  events: {
    ...
    E5: {
      title: "準備帰り、喫茶店に寄る",
      text: `作業を終えた帰り道、ハナエに誘われる。\n\n「甘いもんで一服してこ」\n\nハナエの行きつけだという喫茶店だった。注文を終えたところで、ハナエが伝票に手を伸ばした。\n\n「ここは奢ったるわ」`,
      choices: [
    ...
    E16: {
      title: "展示物のトラブル",
      text: `夏休みが明けて、文化祭まで一週間を切った。そこへ突然のトラブル。展示物の一部が壊れているのが見つかった。作業は押しており、他の委員から責任の押し付け合いが始まる。ハナエは黙って修復作業に取り掛かろうとしている。`,
      choices: [
    ...
    E18: {
      ...
      text: `文化祭まであと二日。台風接近のニュース。屋外展示が吹き飛ばされる恐れがあり、吊るしたばかりの提灯も含めて急遽の対応が必要になった。「これ全部、今日中に固定せなあかん……」ハナエの声にも焦りが滲む。`,
      choices: [
  ...
  freePool: {
    ...
    F4_baiten: {
      ...
      text: `作業の昼休み。夏休み中でも部活組のために開いている購買の前に、短い行列ができていた。隣にハナエが並んでいた。カウンターのサンドイッチを覗き込み、ふと顔をしかめる。「うわ、これ生姜焼きサンドやん……無理やわ、生姜」`,
      choices: [
