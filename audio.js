...
const AUDIO = (() => {
  ...
  const CUES = {
    ...
    // 短く重ねる。sine なので倍音が無く、耳に刺さらない。
    // 2026-09-05 に本人指示で 1450ms → 430ms に短縮(音程と音量はそのまま)
    start: () => {
      tone(523.25, 200, "sine", 0.13, 0, 18);
      setTimeout(() => tone(783.99, 220, "sine", 0.12, 0, 14), 60);
      setTimeout(() => tone(1046.5, 300, "sine", 0.11, 0, 14), 130);
    },
    ending: () => {
